...
class TranslationsModulesHomeEn {
	...
	/// en: '(zero) {You have not clicked on any time} (one) {You have clicked on $n time} (other) {You have clicked on $n times}'
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'modules.home.counter': return ({required num n}) => (_root.$meta.cardinalResolver ?? PluralResolvers.cardinal('en'))(n,
				zero: 'You have not clicked on any time',
				one: 'You have clicked on ${n} time',
				other: 'You have clicked on ${n} times',
			);
